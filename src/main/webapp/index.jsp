            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="tn-right">
                        ...
                        <a href="login" class="bk-btn">Sign in</a>
                        <a href="sign-up" class="bk-btn">Sign up</a>
                        ...
                        <div class="top-social">
                            <!--                                <input style="border:none; padding: 7px; border-radius: 10px 10px 10px 10px ; margin-right: 2px; margin-left: 20px;" class="bk-btn" type="button" value="">-->
                        </div>
                    </div>
                </div>
            </div>
...
<section class="hero-section">
    ...
    <div class="hero-slider owl-carousel">
        <img src="assets/img/home/ninh-van-bay-vietnam-rock_villa_bedroom25574.jpg" class="mx-auto d-block" width="100%"
             height="100%" alt="">
    </div>
</section>
            ...
            <div class="col-lg-6">
                <div class="about-text">
                    ...
                    <p> Luna.com is a leading online accommodation website. We are passionate about travel.
                        ...
                        So when it comes to booking the perfect hotel, vacation rental, guesthouse, we've got you
                        covered.
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg">
                        <img src="assets/img/home/ninh-van-bay-vietnam-rock_villa_bedroom25574.jpg" width="100%"
                             height="100%" alt="">
                        <div class="hr-text">
                            <h3>Double Room</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg">
                        <img src="assets/img/home/ninh-van-bay-vietnam-water-pool-villa-bathroom.jpg" width="100%"
                             height="100%" alt="">
                        <div class="hr-text">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg">
                        <img src="assets/img/home/water_pool_villa-aerial_-8381-large-1.jpg" width="100%" height="100%"
                             alt="">
                        <div class="hr-text">
                            <h3>Deluxe Room</h3>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="hp-room-item set-bg">
                        <img src="assets/img/home/ninh-van-bay-vietnam-hiking_trail-5567.jpg" width="100%" height="100%"
                             alt="">
                        <div class="hr-text">
                            <h3>Family Room</h3>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="blog-item set-bg">
                    <img src="assets/img/home/ninh-van-bay-vietnam-black-shanked-douc-langur.jpg" width="100%"
                         height="100%" alt="">
                    <div class="bi-text">
            ...
            <div class="col-lg-8">
                <div class="blog-item small-size set-bg">
                    <img src="assets/img/home/ninh_van_bay_vietnam_rock_pool_villa_aerial2.jpg" width="100%"
                         height="100%" alt="">
                    <div class="bi-text">
                        <span class="b-tag">Event</span>

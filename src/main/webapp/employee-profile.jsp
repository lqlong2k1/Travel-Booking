        ...
        <div class="row">
            ...
            <div class="col-md-5 border-right">
                <div class="p-3 py-5">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h4 class="text-right">Yor profile</h4>
                    </div>
                    <form>
                        <div class="row mt-2">
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" value="${employee.phoneNumber}" readonly>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="password" class="form-control" value="${employee.password}" readonly>
                            </div>
                        </div>
            ...
            <div class="col-md-4">
                <div class="p-3 py-5">
                    ...
                    <br>
                    <div class="col-md-12">
                        <label class="labels">Hotel Code</label>
                        <input type="text" class="form-control" value="${employee.hotelID}" readonly>
                    </div>
                    <br>
                    <div class="col-md-12">
                        <label class="labels">Position</label>
                        <input type="text" class="form-control" value="${employee.roleName}" readonly>
                    </div>
                    <div class="col-md-12">
                        <label class="labels">Salary</label>
                        <input type="text" class="form-control" value="${employee.salary} VND/Month" readonly>
                    </div>
                </div>
            </div>
        </div>
